...
export const projectHighlights: ProjectHighlight[] = [
  ...
  },
  {
    ...
    year: "2022",
    featureImage: "/images/alinour-feature.png",
    featureImageAlt: "Alinour skincare brand identity featuring elegant serif logotype with tagline As Soothing As Moonlight",
    keyVisuals: [
      { src: "/images/alinour-key-1.png", alt: "Alinour Day Cream packaging design showing minimalist white box and glass jar with purple lid, alongside black zen stones" },
      { src: "/images/alinour-key-2.png", alt: "Alinour Superfood AHA Glow Cleansing Butter product photography with vibrant orange packaging on a pumpkin" },
    ],
    description: "Dr.\u00a0Noor is a physician who developed a skincare line combining medical expertise with premium ingredients, including Moroccan-sourced botanicals. She needed a brand that communicated science-backed luxury, precise, modern, and high-end.\n\nThe key strategic decision was positioning Alinour alongside premium clinical competitors rather than leaning into the natural ingredient story. After presenting both directions through mood boards, I guided the client toward a clean, sophisticated identity that signals laboratory precision over heritage craft. The result is a brand that competes visually with high-end skincare rather than blending into the organic market.",
  },
]
